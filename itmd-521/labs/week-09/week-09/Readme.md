...
- Use Native Pyspark file methods![part 1](<images/code 1.png>)
...
- Repeat the previous command that writes the DataFrame to the database, but set the mode type to `errorifexists` -- take a screenshot of the error message generated and place it here![part 2](<images/code 2.png>)
...
Example will look something like this:![sql output](images/sql.png)
